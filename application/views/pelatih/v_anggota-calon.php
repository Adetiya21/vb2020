			...
			<div class="col-lg-4">
				<div class="page-header-breadcrumb">
					<ul class=" breadcrumb breadcrumb-title">
						...
						<li class="breadcrumb-item">
							<a href="<?= site_url('pelatih/anggota/calon') ?>">Calon Anggota</a>
						</li>
					</ul>
				</div>
			</div>
...
<script type="text/javascript">
    ...
    var table = $('#compact').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: {"url": "<?= base_url() ?>pelatih/anggota/json_calon", "type": "POST"},
        columns: [
        {
            "data": "id",
            "orderable": false
    ...
    function edit(id)
    {
	    ...
	    $.ajax({
	        url : '<?php echo site_url("pelatih/anggota/edit/'+id+'") ?>',
	        type: "GET",
	        dataType: "JSON",
	        success: function(data)
	        {
	            ...
	            $('.modal-title').text('Edit Status Anggota'); // Set title to Bootstrap modal title
	        },
    ...
    function view(id)
    {
        ...
        $.ajax({
            ...
            success: function(data)
            {
                ...
                $('.modal-title').text('Preview Data Calon Anggota'); // Set title to Bootstrap modal title
            },
            error: function (jqXHR, textStatus, errorThrown)
            {
                alert('Error get data from ajax');
    ...
    function save()
    {
        ...
        $.ajax({
            url : '<?php echo site_url('pelatih/anggota/update')?>',
            type: "POST",
            data: formData,
            contentType: false,
            processData: false,
            ...
            <div class="modal-body form">
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label >Posisi</label>
                            <input type="text" class="form-control" placeholder="Posisi" name="posisi" readonly/>
                            <span class="help-block"></span>
                        </div>
                        <div class="form-group">
                            <label >Status</label>
