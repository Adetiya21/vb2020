		...
		<div class="row align-items-end">
			<div class="col-lg-8">
				<div class="page-header-title">
					...
					<div class="d-inline">
						<h5>Pengumuman Tes Calon Anggota</h5>
						<span>Berikut daftar pengumuman tes calon anggota club.</span>
					</div>
				</div>
			</div>
			<div class="col-lg-4">
				<div class="page-header-breadcrumb">
					<ul class=" breadcrumb breadcrumb-title">
						...
						<li class="breadcrumb-item">
							<a href="<?= site_url('pelatih/pengumuman') ?>">Pengumuman Tes</a>
						</li>
					</ul>
				</div>
			</div>
...
<script type="text/javascript">
    ...
    var table = $('#compact').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: {"url": "<?= base_url() ?>pelatih/pengumuman/json", "type": "POST"},
        columns: [
        {
            "data": "id",
            "orderable": false
