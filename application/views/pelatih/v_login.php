            ...
            <div class="auth-box row">
                ...
                <div class="col-lg-6 col-md-7 bg-white">
                    <div class="p-3">
                        ...
                        <h2 class="mt-3 text-center">LOGIN PELATIH</h2>
                        <p class="text-center">Login untuk dapat memanagemen data website</p>
                        <?= $this->session->flashdata('pesan'); ?>
                        <?= $this->session->flashdata('error'); ?>
                        <?= form_open('pelatih/welcome/login'); ?>
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="text-dark" for="uname">Email</label>
                                        <input class="form-control" id="uname" type="text" name="email" 
                                            placeholder="Masukkan Email" value="<?= $this->session->flashdata('email'); ?>">
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
