...
<script type="text/javascript">
    ...
    var table = $('#compact').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: {"url": "<?= base_url() ?>pelatih/pengumuman/json_hasil/<?= $id_jtes ?>", "type": "POST"},
        columns: [
        {
            "data": "id",
            "orderable": false
    ...
    function hapus(id)
    {
        if(confirm('Anda yakin ingin menghapus data?'))
        {
            ...
            $.ajax({
                url : '<?php echo site_url("pelatih/pengumuman/hapus/'+id+'") ?>',
                type: "POST",
                dataType: "JSON",
    ...
    function save()
    {
        ...
        $.ajax({
            url : '<?php echo site_url('pelatih/pengumuman/tambah')?>',
            type: "POST",
            data: formData,
            contentType: false,
            processData: false,
