...
<script>
    $(document).ready(function() {
      ...
      $('.jadwal-latihan').addClass('active');
  	});
</script>
			...
			<div class="col-lg-8">
				<div class="page-header-title">
					...
					<div class="d-inline">
						...
						<span>Berikut daftar jadwal latihan club.</span>
					</div>
				</div>
			</div>
			<div class="col-lg-4">
				<div class="page-header-breadcrumb">
					<ul class=" breadcrumb breadcrumb-title">
						...
						<li class="breadcrumb-item">
							<a href="<?= site_url('pelatih/jadwal-latihan') ?>">Jadwal Latihan</a>
						</li>
					</ul>
				</div>
			</div>
...
<script type="text/javascript">
    ...
    var table = $('#compact').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: {"url": "<?= base_url() ?>pelatih/jadwal_latihan/json", "type": "POST"},
        columns: [
        {
            "data": "id",
            "orderable": false
    ...
    function hapus(id)
    {
        if(confirm('Anda yakin ingin menghapus data?'))
        {
            ...
            $.ajax({
                url : '<?php echo site_url("pelatih/jadwal_latihan/hapus/'+id+'") ?>',
                type: "POST",
                dataType: "JSON",
    ...
    function tambah()
    {
        ...
        $('.modal-title').text('Tambah Jadwal Latihan'); // Set Title to Bootstrap modal title
    }
    ...
    function edit(id)
    {
	    ...
	    $('.help-block').empty(); // clear error string
	    $.ajax({
	        url : '<?php echo site_url("pelatih/jadwal_latihan/edit/'+id+'") ?>',
	        type: "GET",
	        dataType: "JSON",
	        success: function(data)
	        {
	            ...
	            $('.modal-title').text('Edit Data Jadwal Latihan'); // Set title to Bootstrap modal title
	        },
	        error: function (jqXHR, textStatus, errorThrown)
	        {
    ...
    function save()
    {
	    ...
	    if(save_method == 'add') {
	        url = "<?php echo site_url('pelatih/jadwal_latihan/tambah')?>";
	    } else {
	        url = "<?php echo site_url('pelatih/jadwal_latihan/update')?>";
	    }
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="hari" class="form-control">
                            	...
                            	<option value="Jumat">Senin</option>
                        ...
                        <div class="form-group">
                            <label >Jam Mulai Latihan</label>
                            <input type="time" class="form-control" name="jam_mulai">
                            <span class="help-block"></span>
                        </div>
                        <div class="form-group">
                            <label >Jam Selesai Latihan</label>
