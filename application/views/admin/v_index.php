			...
			<div class="page-wrapper">
				<div class="page-body">
					<div class="row">
						...
						<div class="col-xl-4 col-md-6">
							<a href="<?= site_url('admin/pengurus') ?>" class="card prod-p-card card-blue">
								<div class="card-body">
									<div class="row align-items-center m-b-30">
										<div class="col">
						...
						<div class="col-xl-4 col-md-6">
							<a href="<?= site_url('admin/pelatih') ?>" class="card prod-p-card card-yellow">
								<div class="card-body">
									<div class="row align-items-center m-b-30">
										<div class="col">
						...
						<div class="col-xl-4 col-md-6">
							<a href="<?= site_url('admin/anggota/calon') ?>" class="card comp-card">
								<div class="card-body">
									<div class="row align-items-center">
										<div class="col">
											<h6 class="m-b-25">Total Calon Anggota</h6>
											<h3 class="f-w-700 text-c-red"><?= $canggota ?> Orang</h3>
										</div>
										<div class="col-auto">
						...
						<div class="col-xl-4 col-md-6">
							<a href="<?= site_url('admin/anggota') ?>" class="card comp-card">
								<div class="card-body">
									<div class="row align-items-center">
										<div class="col">
											<h6 class="m-b-25">Total Pemain / Anggota</h6>
											<h3 class="f-w-700 text-c-blue"><?= $anggota ?> Orang</h3>
										</div>
										<div class="col-auto">
						...
						<div class="col-xl-4 col-md-6">
							<a href="<?= site_url('admin/prestasi-club') ?>" class="card comp-card">
								<div class="card-body">
									<div class="row align-items-center">
										<div class="col">
											<h6 class="m-b-25">Total Prestasi</h6>
											<h3 class="f-w-700 text-c-yellow"><?= $prestasi ?> Data</h3>
										</div>
										<div class="col-auto">
											<i class="fas fa-book bg-c-yellow"></i>
										</div>
									</div>
								</div>
							</a>
								...
								<div class="card-block">
									<div class="">
										...
										<div class="pull-right" style="padding-right: 20px;">
											<a href="<?= site_url('admin/anggota/calon') ?>">Selengkapnya..</a>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="card-block">
									<div class="">
										...
										<div class="pull-right" style="right:0 ;padding-right: 20px;">
											<a href="<?= site_url('admin/jadwal-tes') ?>">Selengkapnya..</a>
										</div>
									</div>
								</div>
							</div>
