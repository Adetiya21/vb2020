		...
		<div class="row align-items-end">
			<div class="col-lg-8">
				<div class="page-header-title">
					...
					<div class="d-inline">
						<h5>Pengurus</h5>
						<span>Berikut daftar para pengurus club.</span>
					</div>
				</div>
			</div>
			<div class="col-lg-4">
				<div class="page-header-breadcrumb">
					<ul class=" breadcrumb breadcrumb-title">
						...
						<li class="breadcrumb-item">
							<a href="<?= site_url('admin/pengurus') ?>">Pengurus</a>
						</li>
					</ul>
				</div>
			</div>
...
<script type="text/javascript">
    ...
    var table = $('#compact').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: {"url": "<?= base_url() ?>admin/pengurus/json", "type": "POST"},
        columns: [
        {
            "data": "id",
            "orderable": false
    ...
    function hapus(id)
    {
        if(confirm('Anda yakin ingin menghapus data?'))
        {
            ...
            $.ajax({
                url : '<?php echo site_url("admin/pengurus/hapus/'+id+'") ?>',
                type: "POST",
                dataType: "JSON",
    ...
    function edit(id)
    {
	    ...
	    $('.help-block').empty(); // clear error string
	    $.ajax({
	        url : '<?php echo site_url("admin/pengurus/edit/'+id+'") ?>',
	        type: "GET",
	        dataType: "JSON",
	        success: function(data)
	        {
	            ...
	            $('.modal-title').text('Edit Data Pengurus'); // Set title to Bootstrap modal title
                if(data.gambar)
                {
                    $('#label-photo').text('Change Photo'); // label photo upload
                    $('#photo-preview div').html('<img id="uploadPreview1" src="<?= base_url('assets/assets/img/pengurus/') ?>'+data.gambar+'" width="300px" class="img-thumbnail">'); // show photo
    ...
    function view(id)
    {
        ...
        $.ajax({
            ...
            success: function(data)
            {
                ...
                $('.modal-title').text('Preview Data Pengurus'); // Set title to Bootstrap modal title
            },
            error: function (jqXHR, textStatus, errorThrown)
            {
                alert('Error get data from ajax');
    ...
    function save()
    {
	    ...
	    if(save_method == 'add') {
	        url = "<?php echo site_url('admin/pengurus/tambah')?>";
	    } else {
	        url = "<?php echo site_url('admin/pengurus/update')?>";
	    }
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                            	<div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Nama Pengurus" name="nama" required/>
