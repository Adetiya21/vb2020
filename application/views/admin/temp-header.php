					...
					<div class="nav-list">
						<div class="pcoded-inner-navbar main-menu">
							...
							<ul class="pcoded-item pcoded-left-item">
								...
								<li class="club pcoded-hasmenu">
									<a href="javascript:void(0)" class="waves-effect waves-dark">
										<span class="pcoded-micon">
											<i class="feather icon-book"></i>
										</span>
										<span class="pcoded-mtext">Club</span>
									</a>
									<ul class="pcoded-submenu">
										<li class="tentang">
											<a href="<?= site_url('admin/tentang-club') ?>" class="waves-effect waves-dark">
												<span class="pcoded-mtext"></span> Tentang Club
											</a>
										</li>
										<li class="kontak">
											<a href="<?= site_url('admin/kontak-club') ?>" class="waves-effect waves-dark">
												<span class="pcoded-mtext"></span> Kontak Club
											</a>
										</li>
										<li class="prestasi">
											<a href="<?= site_url('admin/prestasi-club') ?>" class="waves-effect waves-dark">
												<span class="pcoded-mtext"></span> Prestasi Club
											</a>
										</li>
									</ul>
								</li>
								...
								<li class="pengurus">
									<a href="<?= site_url('admin/pengurus') ?>" class="waves-effect waves-dark">
										<span class="pcoded-micon">
								...
								<li class="pelatih">
									<a href="<?= site_url('admin/pelatih') ?>" class="waves-effect waves-dark">
										<span class="pcoded-micon">
								...
								<li class="anggota pcoded-hasmenu">
									...
									<ul class="pcoded-submenu">
										<li class="anggota-pemain">
											<a href="<?= site_url('admin/anggota') ?>" class="waves-effect waves-dark">
												<span class="pcoded-mtext"></span> Daftar Anggota
											</a>
										</li>
										<li class="anggota-calon">
											<a href="<?= site_url('admin/anggota/calon') ?>" class="waves-effect waves-dark">
								...
								<li class="jadwal pcoded-hasmenu">
									...
									<ul class="pcoded-submenu">
										<li class="jadwal-tes">
											<a href="<?= site_url('admin/jadwal-tes') ?>" class="waves-effect waves-dark">
												<span class="pcoded-mtext"></span> Jadwal Tes Anggota
											</a>
										</li>
										<li class="jadwal-latihan">
											<a href="<?= site_url('admin/jadwal-latihan') ?>" class="waves-effect waves-dark">
								...
								<li class="pengumuman">
									<a href="<?= site_url('admin/pengumuman') ?>" class="waves-effect waves-dark">
										<span class="pcoded-micon">
