...
<script type="text/javascript">
    ...
    function save()
    {
        ...
        if(save_method == 'add') {
            url = "<?php echo site_url('admin/admin/tambah')?>"; //aksi jika tombol tambah diklik
        } else {
            url = "<?php echo site_url('admin/admin/update')?>"; //aksi jika tombol edit diklik
        }
